...
def main():
  ...
  parser.add_argument('--rows', dest='row_seeds', type=_parse_num_range, help='Random seeds to use for image rows',
                      required=True)
  parser.add_argument('--cols', dest='col_seeds', type=_parse_num_range, help='Random seeds to use for image columns',
                      required=True)
  parser.add_argument('--styles', dest='col_styles', type=_parse_num_range,
